...
export const Button: React.FC<PropsButton> = ({ text = "read more", onClick, disabled = false, isLoading = false, arrowIcon = false, deleteButton = false }) => {

    return (
        <div>
            {deleteButton ? <button
                className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto py-3 px-5 text-center"
                onClick={onClick}
            >
